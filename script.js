...
function avaliar(){
    ...
    if ( resp == ''){
        document.window.alert('Please select a number')
    }else{
        ...
        sup.innerHTML += `<p id='selected'>You selected ${resp} out of 5<p>`
        document.getElementById('selected').addClass 
        document.getElementById('selected').style.color = '#fb7413'
        document.getElementById('selected').style.width = '12rem'
        document.getElementById('selected').style.height = '1.7rem'
        document.getElementById('selected').style.marginLeft = '20%'
        document.getElementById('selected').style.backgroundColor = '#7c879825'
        document.getElementById('selected').style.borderRadius = '5rem'
        inf.innerHTML = '<h1> Thank you!<h1> <p> We appreciate you taking the time to give a rating. If you ever need more support, dont hesitate to get in touch! <p>'
        }
    }